            ...
            <div class="container-fluid">
                ...
                <div class="card-group">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate"url("assets/images/itm.jpg")></h6>
						<a href="view-students-acc.php">Registered Students</a>
                                </div>
                    ...
                    <div class="card border-right">
						...
						<a href="manage-rooms.php">Total Rooms</a>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card border-right">
						...
						<a href="bookings.php">Booked Rooms</a>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate"></h6>
						<a href="manage-courses.php">Featured Courses</a>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
