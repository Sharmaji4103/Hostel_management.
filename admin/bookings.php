                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Block</h4>
                                    <div class="form-group">
                                        <input type="text" id="seater" name="seater" placeholder="Enter Block No." required class="form-control">
                                    </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra Rs2000 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
