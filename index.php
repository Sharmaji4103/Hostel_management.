<?php
    ...
    $stmt=$mysqli->prepare("SELECT email,password,id FROM userregistration WHERE email=? and password=? ");
        ...
        $mysqli->query($log);
        if($log){
            header("location:student/das.php");
                 }
        } else {
...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
           style="background-image: url(assets/images/red4.jpg) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-5 col-md-5 modal-bg-img" style="background-image: url(assets/images/itm.jpg);">
                </div>
                    ...
                    <div class="p-3">
                        ...
                        <form class="mt-4" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                   <a href="admin/index2.php" class="text-danger">Go to Warden Panel</a>
                                </div>
                            </div>
                        </form>
                    </div>
